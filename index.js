...
export var Keycloak = function (config) {
    ...
    kc.init = function (initOptions) {
        ...
        var adapters = ['default', 'cordova', 'cordova-native', 'capacitor'];
    ...
    function loadAdapter(type) {
        ...
        if (type == 'capacitor') {
            ...
            const noop = (data) => { };
            var openUrlHandler = noop;
            cap.App.addListener('appUrlOpen', (data) => openUrlHandler(data));
            ...
            return {
                ...
                logout: function(options) {
                    ...
                    cap.Browser.open({ url: logoutUrl });
                    return promise.promise;
                },
                ...
                accountManagement : function() {
                    var accountUrl = kc.createAccountUrl();
                    if (typeof accountUrl !== 'undefined') {
                        cap.Browser.open({ url: accountUrl });
                    } else {
                        throw "Not supported by the OIDC server";
                    }
                },
